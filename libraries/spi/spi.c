...
void SPI_init(void) 
{
	...
	PORTD->PCR[0] = PORT_PCR_MUX(2);  // PCS  - PORTD0
	PORTD->PCR[1] = PORT_PCR_MUX(2);  // SCK  - PORTD1
	PORTD->PCR[2] = PORT_PCR_MUX(2);  // MOSI - PORTD2
	PORTD->PCR[3] = PORT_PCR_MUX(2);  // MISO - PORTD4
